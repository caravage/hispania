...
1479:{
  ...
  opts:[
   {label:"Union personnelle stricte : chaque royaume garde ses lois, ses Cortès et son trésor.",
    ...
    out:{
      crit:{t:"Les Catalans exigent des garanties si étendues que le roi y perd une partie de ce que son père détenait.", e:{au:-8,t:-2,ch:"On jura les fueros, et l'on jura plus qu'on ne voulait."}},
      ...
      succ:{t:"Le serment de Barcelone se passe bien. La flotte aragonaise et les juristes catalans entrent au service de la couronne commune.", e:{au:10,t:3,co:5,flag:"union_personnelle",ch:"L'Aragon apporta ses galères, ses juristes et ses querelles."}},
      tri:{t:"L'union est présentée comme une restauration plutôt qu'une conquête. Valence vote un service, ce qu'elle ne faisait plus depuis vingt ans.", e:{au:13,t:5,co:9,flag:"union_personnelle",ch:"On fit d'un héritage une réconciliation."}}
    }},
   {label:"Créer un Conseil des Deux Couronnes, compétent pour la guerre, la diplomatie et les levées communes.",
    ...
    out:{
      ...
      fail:{t:"Le Conseil est créé, siège deux fois, et se dissout faute de compétence reconnue nulle part.", e:{au:-7,t:-2,ch:"Le conseil commun n'eut de commun que le nom."}},
      ...
      succ:{t:"Guerre et diplomatie passent au Conseil commun. Les levées restent séparées, mais l'architecture existe.", e:{au:15,t:3,flag:"conseil_deux",ch:"Pour la première fois, une décision fut prise au nom des deux royaumes ensemble."}},
      tri:{t:"Le Conseil obtient jusqu'à une compétence fiscale limitée. Ce qui naît là ne ressemble plus à une union personnelle mais à un État.", e:{au:20,t:5,co:8,flag:"conseil_deux",flag2:"etat_commun",ch:"Ce ne fut plus un roi portant deux couronnes, mais un royaume en portant deux noms."}}
    }},
   {label:"Faire financer l'effort commun par l'Aragon en invoquant l'héritage, avant que les Corts ne s'organisent.",
    ...
    out:{
      ...
      part:{t:"Valence consent un service ; la Catalogne et l'Aragon refusent. Le précédent existe, à moitié.", e:{t:3,co:-5,ch:"Un royaume paya, deux refusèrent, et l'on retint le premier."}},
      succ:{t:"Un service extraordinaire est voté. Le principe qu'un effort castillan peut être financé par l'Aragon vient d'être admis une fois.", e:{t:6,au:9,flag:"precedent_fiscal",ch:"On obtint un précédent, ce qui vaut mieux qu'un trésor."}},
      tri:{t:"Non seulement le service est voté, mais il est renouvelable. Le principal obstacle structurel de la double monarchie vient d'être entamé.", e:{t:9,au:13,co:5,flag:"precedent_fiscal",flag2:"fiscalite_commune",ch:"L'Aragon paya pour la Castille, ce qui n'était jamais arrivé et devint une habitude."}}
    }}
  ]
},
...
1480:{
  ...
  opts:[
   {label:"Voter la Déclaratoire : reprise partielle et graduée des rentes concédées, selon l'ancienneté du service.",
    ...
    out:{
      crit:{t:"La gradation est jugée arbitraire. Trois maisons se coalisent, et l'on doit suspendre la mesure sans avoir rien encaissé.", e:{au:-14,no:-12,t:-1,ch:"On voulut ne fâcher personne et l'on fâcha tout le monde."}},
      fail:{t:"Les reprises sont contestées cas par cas. Le rendement réel est le tiers de ce qu'on attendait.", e:{t:3,no:-8,ch:"Chaque rente reprise coûta un procès."}},
      part:{t:"La mesure passe. Le revenu royal remonte nettement ; la rancune s'installe pour une génération.", e:{t:7,au:8,no:-11,co:6,flag:"declaratoire",ch:"La couronne reprit ce qu'elle avait donné, et l'on ne le lui pardonna pas."}},
      succ:{t:"La gradation par ancienneté de service désarme les protestations : les plus anciens fidèles perdent le moins. Le trésor double presque.", e:{t:10,au:13,no:-7,co:9,flag:"declaratoire",ch:"On reprit beaucoup en donnant l'impression de ménager chacun."}},
      tri:{t:"L'opération est menée avec une telle maîtrise comptable que plusieurs seigneurs restituent volontairement pour ne pas être mis en cause. Le revenu royal est refondé.", e:{t:13,au:17,no:-4,co:12,flag:"declaratoire",flag2:"finances_refondees",ch:"Il se trouva des grands pour rendre d'eux-mêmes, ce qui valut mieux que la contrainte."}}
    }},
   {label:"Renoncer à la reprise et négocier à la place un impôt permanent sur le commerce des laines.",
    ...
    out:{
      crit:{t:"Les marchands de Burgos et la Mesta font front. L'impôt est voté puis rendu inapplicable par une nuée d'exemptions.", e:{co:-14,pr:-8,t:-1,ch:"On vota un impôt que personne ne paya."}},
      fail:{t:"L'impôt rentre mal et détourne une part du commerce vers les ports portugais.", e:{t:2,pr:-7,co:-7,ch:"La laine trouva d'autres chemins que ceux du fisc."}},
      part:{t:"L'impôt rapporte, moins que la Déclaratoire, et la noblesse reste intacte — puissante, propriétaire, et reconnaissante.", e:{t:5,no:12,co:-8,pr:-4,ch:"On préféra la gratitude des grands au revenu des rentes."}},
      succ:{t:"Le prélèvement sur les laines devient la ressource stable que la Castille n'avait pas. Les grands, épargnés, servent loyalement.", e:{t:8,no:15,co:-5,flag:"impot_laines",ch:"La laine paya ce que les seigneurs ne payèrent pas."}},
      tri:{t:"L'impôt est accepté, indexé et administré par des officiers royaux. La couronne gagne un revenu régulier sans avoir créé un seul ennemi de rang.", e:{t:11,no:18,au:9,flag:"impot_laines",flag2:"fisc_commercial",ch:"On trouva le moyen rare d'enrichir la couronne sans blesser personne d'important."}}
    }},
   {label:"Proposer aux Cortès un contrat : impôt régulier consenti chaque décennie, contre droit de regard sur la dépense.",
    ...
    out:{
      ...
      fail:{t:"Ni les Cortès ni le Conseil royal ne comprennent la proposition. Elle meurt de son étrangeté.", e:{au:-8,t:-2,ch:"On proposa une chose que personne ne sut nommer."}},
      part:{t:"Un accord limité est trouvé : les Cortès voteront décennalement et vérifieront les comptes de guerre seulement.", e:{co:16,t:4,flag:"contrat_cortes",ch:"Les villes obtinrent de voir les comptes de la guerre, ce qui les rendit étonnamment généreuses."}},
      succ:{t:"Le contrat est signé. Le revenu devient prévisible pour la première fois depuis un siècle, et les Cortès deviennent une alliée plutôt qu'un obstacle.", e:{co:22,t:8,au:8,flag:"contrat_cortes",ch:"On échangea du secret contre de l'argent, et l'échange fut bon."}},
      tri:{t:"L'institution née à Tolède ne ressemble à rien de connu : une couronne forte qui rend des comptes. Les procureurs votent au-delà de ce qu'on demandait.", e:{co:26,t:11,au:14,flag:"contrat_cortes",flag2:"budget_consenti",ch:"Il naquit à Tolède une manière de gouverner dont aucun royaume n'avait l'exemple."}}
    }}
  ]
},
...
1481:{
  ...
  opts:[
   {label:"Riposter sur la frontière sans déclarer la guerre : razzias, tours, contre-raids.",
    ...
    out:{
      crit:{t:"Les contre-raids échouent et Grenade prend deux places de plus. La frontière est plus mauvaise qu'avant Zahara.", e:{au:-12,pr:-6,t:-2,ch:"On répondit à un coup de main par trois, et l'on en reçut cinq."}},
      ...
      succ:{t:"Les tours de guet sont refaites, les razzias efficaces, et Grenade demande une trêve — que l'on peut désormais accorder ou refuser.", e:{au:9,t:2,flag:"frontiere_armee",ch:"Pour la première fois depuis longtemps, ce fut Grenade qui demanda la trêve."}},
      tri:{t:"La frontière militarisée devient rentable : parias, tributs, butin. La guerre s'auto-finance avant même d'avoir commencé.", e:{au:12,t:5,flag:"frontiere_armee",flag2:"frontiere_rentable",ch:"On fit de la frontière une ferme, et elle rapporta."}}
    }},
   {label:"Écouter Ponce de León et tenter Alhama : un coup de main au cœur du royaume grenadin.",
    ...
    out:{
      crit:{t:"La colonne est interceptée dans la sierra. Le marquis s'échappe, l'essentiel de sa troupe non, et l'Andalousie apprend qu'elle est sans défense.", e:{guerre:"grenade",au:-17,no:-10,t:-2,pr:-5,ch:"On envoya des hommes derrière les montagnes et ils n'en revinrent pas."}},
      fail:{t:"L'escalade échoue de peu. La surprise est perdue et Grenade fortifie tout ce qui pouvait l'être.", e:{guerre:"grenade",au:-8,t:-2,ch:"Il manqua une échelle et deux heures de nuit."}},
      part:{t:"Alhama tombe et devient aussitôt intenable : il faut la ravitailler à travers le territoire ennemi, indéfiniment.", e:{guerre:"grenade",au:8,t:-3,flag:"alhama",inject:["siege_alhama"],flag2:"guerre_grenade",ch:"On prit une ville qu'il fallut ensuite nourrir à bout de bras."}},
      ...
      tri:{t:"La prise est si nette qu'elle vaut proclamation. Rome accorde la bulle de croisade et l'argent de la chrétienté commence à entrer.", e:{guerre:"grenade",au:18,t:4,no:9,flag:"alhama",inject:["siege_alhama"],flag2:"guerre_grenade",flag3:"bulle_croisade",ch:"Une échelle posée de nuit sur un mur ouvrit dix ans de guerre et vingt ans de gloire."}}
    }},
   {label:"Négocier avec Grenade : restitution de Zahara, tribut, et une trêve longue garantie par écrit.",
    ...
    out:{
      ...
      part:{t:"Une trêve de sept ans est signée, Zahara rendue. La frontière est calme et l'Andalousie furieuse.", e:{t:4,pr:8,no:-12,flag:"treve_grenade",ch:"La paix fut signée, et personne en Andalousie ne s'en réjouit."}},
      succ:{t:"La trêve est longue, le tribut substantiel, et le commerce grenadin reprend au bénéfice des ports castillans. On ne fera pas la guerre.", e:{t:7,pr:14,no:-10,flag:"treve_grenade",ch:"Grenade paya plus en tribut qu'elle n'aurait valu en butin."}},
      tri:{t:"L'accord va au-delà : Grenade devient vassale tributaire, ouvre ses ports, et la Castille se tourne vers l'Atlantique dix ans avant l'heure.", e:{t:9,pr:19,au:9,no:-9,flag:"grenade_vassale",flag2:"ocean_dabord",ch:"On garda Grenade comme un tributaire plutôt qu'un trophée, et l'on regarda vers la mer."}}
    }}
  ]
},
  ...
  opts:[
   {label:"Marcher sur Loja immédiatement, avec ce qu'on a.",
    ...
    out:{
      ...
      fail:{t:"Le siège est levé après trois semaines. Rien de perdu que le temps, l'argent et la réputation.", e:{au:-9,t:-2,ch:"On assiégea Loja et l'on s'en retourna."}},
   ...
   {label:"Différer d'un an et employer l'année à fondre des bombardes.",
    ...
    out:{
      crit:{t:"Les fondeurs sont mal payés et repartent. On a perdu la saison et l'argent, et Alhama a failli tomber pendant qu'on attendait.", e:{t:-2,au:-10,pr:-5}},
      fail:{t:"Six bombardes, toutes de calibres différents, aucune munition commune.", e:{au:-4,t:-1}},
   ...
   {label:"Renoncer à Loja et acheter la vallée : pensions aux alcaides, tribut à l'émir.",
    ...
    out:{
      crit:{t:"L'argent est pris et dénoncé publiquement à Grenade. On a financé la garnison qu'on voulait acheter et l'on passe pour un roi qui n'ose pas se battre.", e:{t:-3,au:-14,no:-10}},
      fail:{t:"Deux alcaides prennent l'or, aucun ne bouge.", e:{t:-2,au:-6,no:-4}},
      part:{t:"La vallée devient poreuse. Les convois pour Alhama passent moyennant péage.", e:{t:-1,pr:4,au:2}},
  ...
  opts:[
   {label:"Le relâcher contre vassalité, tribut et guerre civile à Grenade.",
    ...
    out:{
      ...
      fail:{t:"Il rentre, prête serment, ne paie rien et ne combat personne.", e:{au:-6,t:-1}},
      part:{t:"Grenade se divise en deux obédiences. La frontière est plus calme, l'émirat plus faible.", e:{au:5,pr:3}},
      succ:{t:"La guerre civile éclate à Grenade. Deux émirs, deux capitales, et une frontière qui ne menace plus personne.", e:{au:11,pr:6,t:3,flag:"grenade_divisee",ch:"On rendit l'émir à son père, et ils se déchirèrent pour nous."}},
      tri:{t:"Boabdil tient l'Albaicín contre son père et paie son tribut avec exactitude. Grenade se fait la guerre à elle-même et la Castille arbitre.", e:{au:16,pr:9,t:5,flag:"grenade_divisee",flag2:"grenade_vassale",ch:"L'émir de Grenade devint le vassal de Castille contre son propre père."}}
    }},
   {label:"Le garder en otage et négocier place par place contre sa liberté.",
    ...
    out:{
      crit:{t:"Grenade le déclare déchu et se donne un autre émir. On garde un otage sans valeur et l'on a perdu le seul levier qu'on avait.", e:{au:-12,t:-2}},
      ...
      tri:{t:"On monnaye si bien la captivité que la frontière avance de trente lieues sans qu'une bombarde soit tirée. L'émir finit par préférer la Castille à Grenade.", e:{au:15,pr:10,t:3,flag:"otage_royal",flag2:"frontiere_avancee",ch:"On ne rendit jamais l'émir, et l'on prit son royaume place par place."}}
    }},
   {label:"Reconnaître Boabdil roi de Grenade sous protection castillane, et le réinstaller par les armes.",
    ...
    out:{
      crit:{t:"L'armée castillane entre à Grenade pour installer un émir que personne ne veut. Elle en ressort poursuivie, et les deux Grenades s'unissent enfin contre nous.", e:{au:-20,pr:-12,no:-8,t:-3}},
      fail:{t:"L'expédition s'arrête à Loja. Boabdil reste un prétendant sans royaume, entretenu à nos frais.", e:{au:-8,t:-3}},
      part:{t:"Boabdil tient l'Albaicín par nos garnisons. C'est cher et ce n'est pas rien.", e:{au:3,t:-2,pr:-2}},
      succ:{t:"Grenade reconnaît Boabdil, qui reconnaît la Castille. Un royaume musulman sous protection chrétienne, tribut réglé, culte garanti.", e:{au:12,pr:8,t:4,flag:"grenade_protegee",ch:"On fit de Grenade un royaume client, et l'on cessa d'avoir une frontière."}},
      tri:{t:"Le protectorat tient et se révèle une machine à rentes : le tribut de Grenade dépasse ce que trois provinces castillanes rapportent, et la route de Berbérie s'ouvre. Nul n'a jamais tenté cela.", e:{au:17,pr:13,t:7,co:6,flag:"grenade_protegee",flag2:"route_berberie",paix:"grenade",ch:"Grenade demeura, et paya. On y gagna plus qu'à la détruire."}}
    }}
  ]
},
  ...
  opts:[
   {label:"Passer outre, garnison à Teruel, tribunal installé de force.",
    ...
    out:{
      ...
      fail:{t:"Le tribunal s'installe et ne juge personne pendant deux ans. On a payé une garnison pour une chaise vide.", e:{co:-8,t:-2,au:-3}},
      part:{t:"Teruel cède. Le tribunal fonctionne, contesté, sous escorte.", e:{au:6,co:-6,pr:-4}},
      succ:{t:"Le Saint-Office s'établit dans les deux couronnes sous une seule autorité. C'est la première institution commune à la Castille et à l'Aragon.", e:{au:13,co:-7,t:3,flag:"office_commun",ch:"Le Saint-Office fut la première chose que les deux couronnes eurent en commun."}},
      tri:{t:"Non seulement le tribunal s'installe, mais le précédent est établi et écrit : sur les matières de foi, la volonté royale prime les fueros. Les juristes en tireront tout le reste.", e:{au:18,co:-9,t:5,flag:"office_commun",flag2:"primaute_royale",ch:"On établit que le roi passait avant le fuero, et l'on ne s'en tint pas à la foi."}}
    }},
   {label:"Négocier : tribunal accepté, confiscations abandonnées, juges aragonais.",
    ...
    out:{
      crit:{t:"Les concessions sont prises pour de la faiblesse et les Corts en demandent d'autres. On n'a ni tribunal ni autorité.", e:{au:-12,co:4,t:-2}},
   ...
   {label:"Suspendre l'extension et borner le tribunal à la Castille par édit.",
    ...
    out:{
      ...
      succ:{t:"On a borné par écrit un pouvoir qui n'en avait pas. Les Corts d'Aragon votent un service extraordinaire de gratitude.", e:{co:15,pr:8,t:4,au:4,flag:"office_borne",ch:"On arrêta le Saint-Office aux frontières de Castille, ce qui ne s'était jamais vu."}},
      tri:{t:"L'édit devient le premier texte du règne à limiter une juridiction royale par une autre. Les légistes aragonais le citeront pendant deux siècles, et l'Aragon sera loyal comme il ne l'a jamais été.", e:{co:20,pr:12,t:5,au:8,flag:"office_borne",flag2:"juridiction_bornee",ch:"Le roi se donna lui-même une limite, et l'Aragon lui fut fidèle pour cela."}}
    }}
  ]
},
...
1485:{
  ...
  opts:[
   {label:"Battre la ville au canon, sans assaut.",
    ...
    out:{
      crit:{t:"Les bombardes éclatent l'une après l'autre, faute de fondeurs. Le siège s'éternise, la peste entre au camp, on lève.", e:{au:-14,pr:-10,t:-3}},
      fail:{t:"Les murs tiennent plus longtemps que prévu et l'on négocie une reddition coûteuse.", e:{t:-3,au:-3}},
   ...
   {label:"Contourner Ronda et couper Málaga de la frontière.",
    ...
    out:{
      ...
      fail:{t:"On ravage sans tenir. Tout est à refaire l'an prochain.", e:{t:-2,au:-4}},
      part:{t:"Les vallées sont tenues, Ronda est isolée sans être prise.", e:{au:5,pr:4}},
      succ:{t:"Málaga est coupée de l'intérieur. Ronda, sans ravitaillement, se rendra d'elle-même dans l'année.", e:{au:10,pr:8,t:2,flag:"serrania"}},
      tri:{t:"La campagne réussit si bien qu'on établit une ligne de places tenues et payées, qui avance chaque année sans bataille. La guerre devient une administration.", e:{au:14,pr:12,t:4,co:5,flag:"serrania",flag2:"frontiere_avancee",ch:"On cessa de prendre des villes et l'on se mit à prendre le pays."}}
    }},
   {label:"Offrir aux villes de la serranía le statut de mudéjars protégés contre reddition sans siège.",
    ...
    out:{
      ...
      fail:{t:"Deux villes traitent, les autres attendent de voir. On ne voit rien de concluant.", e:{au:-4,t:-1}},
      part:{t:"Sept villes se rendent aux conditions. Elles tiennent parole et nous aussi.", e:{au:6,pr:7,t:2}},
      succ:{t:"La serranía entière se rend sans un siège. On gagne une province avec ses habitants, ses moulins et ses récoltes intacts.", e:{au:12,pr:15,t:4,flag:"mudejars_garantis",ch:"On promit aux vaincus leur loi et leurs biens, et ils ouvrirent leurs portes."}},
      tri:{t:"Le statut devient la règle de toute la conquête : les villes se rendent d'avance pour l'obtenir. Le royaume qu'on prend n'est pas ruiné, et il paie l'impôt dès l'année suivante.", e:{au:17,pr:20,t:7,co:8,flag:"mudejars_garantis",flag2:"conquete_menagee",ch:"On conquit un royaume sans le détruire, ce qui n'était jamais arrivé."}}
    }}
  ]
},
...
1486:{
  ...
  opts:[
   ...
   {label:"Accorder les caravelles tout de suite, sur les fonds de la Sainte Hermandad.",
    ...
    out:{
      crit:{t:"L'expédition ne revient pas. Trois navires, leurs équipages et l'argent de la guerre, perdus pour une erreur de calcul dont on était averti.", e:{t:-4,au:-16,co:-12,ch:"On envoya trois navires vers l'ouest et l'on n'en revit aucun."}},
      fail:{t:"L'armement traîne, les pilotes refusent, et l'affaire s'enlise au port.", e:{t:-3,au:-6,co:-5}},
      part:{t:"Les navires partent, atteignent les Canaries, et rebroussent devant l'océan. On sait au moins que la route existe jusque-là.", e:{t:-2,au:-2,pr:2}},
      succ:{t:"Ils reviennent au bout de huit mois avec des hommes de peau cuivrée, de l'or en poudre et des perroquets. La terre est plus petite qu'on ne croyait, ou il y a quelque chose entre.", e:{au:16,pr:12,t:5,co:8,flag:"decouverte",ch:"Six ans avant l'heure, on sut qu'il y avait quelque chose à l'ouest."}},
      tri:{t:"Non seulement ils reviennent, mais ils reviennent avec une route, des relais aux Canaries et un contrat qui réserve tout à la couronne. La Castille a six ans d'avance et personne pour la suivre.", e:{au:22,pr:16,t:9,co:12,flag:"decouverte",flag2:"route_ouest",ch:"On trouva les Indes par l'ouest, et l'on prit soin d'en garder le secret un an."}}
    }},
   {label:"Refuser le titre mais acheter le calcul : payer ses cartes et armer des pilotes castillans.",
    ...
    out:{
      ...
      fail:{t:"On achète des cartes que les pilotes castillans jugent inutilisables.", e:{t:-2,au:-4}},
      part:{t:"Les cartes sont copiées, l'homme s'en va mécontent. On a quelque chose, on ne sait pas quoi.", e:{t:-1,pr:2}},
      succ:{t:"Deux caravelles castillanes partent sans lui et reconnaissent huit cents lieues d'océan vide — assez pour savoir que la route est plus longue qu'il ne disait, et qu'elle existe.", e:{au:9,pr:7,t:2,flag:"pilotes_palos",ch:"On paya ses cartes et l'on envoya nos propres pilotes."}},
      tri:{t:"L'entreprise devient royale de bout en bout : pilotes castillans, navires castillans, cartes tenues au secret par la chancellerie. Ce qui sera trouvé n'aura pas de vice-roi génois à payer.", e:{au:14,pr:10,t:4,co:6,flag:"pilotes_palos",flag2:"route_ouest",ch:"L'océan fut reconnu par des pilotes du roi, et nul n'eut à en toucher le dixième."}}
    }}
  ]
},
...
1487:{
  ...
  opts:[
   {label:"Grenade. Toute la force du royaume vers la frontière du sud.",
    ...
    out:{
      crit:{t:"L'effort est décidé sans les moyens. La première campagne se solde par un désastre dans les défilés de la Axarquía.", e:{au:-12,t:-3,flag:"cap_grenade",ch:"On voulut Grenade avant d'en avoir les moyens."}},
      fail:{t:"La décision est prise, l'organisation suit mal. Le sud engloutira plus qu'il ne devait.", e:{t:-2,flag:"cap_grenade",ch:"On engagea le royaume dans une guerre dont on avait mal compté le prix."}},
      ...
      succ:{t:"L'entreprise est lancée avec méthode : artillerie, ravitaillement, bulle de croisade. Le sud tombera.", e:{au:12,t:3,flag:"cap_grenade",ch:"On prépara la guerre avant de la faire, ce qui était nouveau."}},
      tri:{t:"Tout est en place — argent, canons, alliances, et une chrétienté qui regarde. La conquête est déjà à moitié gagnée.", e:{au:16,t:5,no:8,flag:"cap_grenade",ch:"Il ne resta plus qu'à prendre les villes, ce qui était le plus simple."}}
    }},
   {label:"La mer. Ports, chantiers, Canaries, et ce que les Portugais trouvent au sud.",
    ...
    out:{
      crit:{t:"L'argent part dans des chantiers qui ne produisent rien et l'Andalousie, privée de guerre, se soulève contre les nouveaux impôts.", e:{au:-14,t:-3,no:-10,flag:"cap_mer",ch:"On construisit des quais pendant que l'on demandait des lances."}},
      fail:{t:"Quelques caravelles, quelques comptoirs. Le Portugal garde vingt ans d'avance.", e:{t:-2,flag:"cap_mer",ch:"On regarda la mer sans encore savoir qu'y chercher."}},
      part:{t:"Les Canaries sont soumises, les chantiers de Séville tournent. Le sud attendra.", e:{pr:9,t:2,no:-6,flag:"cap_mer",ch:"On acheva les Canaries et l'on remit Grenade à plus tard."}},
      succ:{t:"Une marine atlantique réelle sort des chantiers. Ce que le Portugal trouvera, la Castille pourra le disputer.", e:{pr:14,t:4,au:6,flag:"cap_mer",ch:"La Castille se donna une flotte avant d'avoir un empire."}},
      tri:{t:"Marine, capitaux et cartographes convergent à Séville. Dix ans d'avance sur l'histoire, et personne à la cour ne sait encore ce que cela vaudra.", e:{pr:19,t:6,au:9,flag:"cap_mer",flag2:"ocean_dabord",ch:"On mit tout dans l'océan, sans savoir ce qu'il y avait au bout."}}
    }},
   {label:"L'intérieur. Achever l'administration, les tribunaux, l'université et les comptes avant toute aventure.",
    ...
    out:{
      ...
      succ:{t:"En dix ans, la Castille se dote de l'appareil administratif que les autres royaumes mettront un siècle à construire.", e:{au:16,pr:14,co:12,t:3,flag:"cap_interieur",ch:"Le royaume devint gouvernable, ce qui valait plusieurs provinces."}},
      tri:{t:"Justice, finance, université et archives forment un ensemble cohérent. Ce que l'on lègue n'est pas une conquête mais une machine.", e:{au:21,pr:18,co:16,t:6,flag:"cap_interieur",flag2:"etat_moderne",ch:"On ne laissa aucune ville prise, et l'on laissa un État."}}
    }}
  ]
}
